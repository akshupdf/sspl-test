...
function Navbar() {
  ...
  return (
    <div className="w-full bg-[#003662]/95 backdrop-blur-md text-white fixed top-0 z-50 shadow-md border-b border-white/5 transition-all duration-300">
      <div className="  mx-auto px-4 md:px-8 w-full flex flex-col lg:flex-row justify-between items-center py-2 lg:py-0">
        <div className="flex justify-between items-center w-full lg:w-auto py-2 lg:justify-start">
          ...
          <div
            className="lg:hidden cursor-pointer p-2 text-white hover:text-blue-200 transition-colors"
            onClick={toggleMenu}
          >
        ...
        <div
          className={`lg:flex lg:items-center lg:justify-end w-full lg:w-auto transition-all duration-300 ${
