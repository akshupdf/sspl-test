...
const countryCodes = [
  ...
  { code: '+61', country: 'Australia', pattern: /^\d{9,10}$/, example: '412345678' },
  ...
  { code: '+81', country: 'Japan', pattern: /^\d{10,11}$/, example: '9012345678' },
  { code: '+971', country: 'UAE', pattern: /^\d{9,10}$/, example: '501234567' },
  { code: '+65', country: 'Singapore', pattern: /^\d{8}$/, example: '91234567' },
];
...
function Contact() {
  ...
  const validateForm = () => {
    ...
    } else if (!validatePhoneNumber(formData.contactNumber, formData.countryCode)) {
        ...
        <div className='xl:w-[50%] 2xl:w-[50%] sm:w-[100%] justify-center items-center sm:flex-none flex'>
          ...
          <div className='rounded-xl border border-black xl:p-10 shadow-xl'>
            <form className="2xl:w-[60vh] xl:w-[80vh] mx-auto sm:w-[50vh] p-4" onSubmit={handleSubmit}>
              ...
              {/* Full Name */}
              <div className="mb-4">
                <label className="block mb-2 text-xl font-medium">Full Name *</label>
                <input
                  value={formData.fullName}
                  onChange={handleChange}
                  name="fullName"
                  className={`bg-gray-50 border ${errors.fullName ? 'border-red-500' : 'border-gray-300'} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5`}
              ...
              {/* Email Address */}
              <div className="mb-4">
                <label className="block mb-2 text-xl font-medium">Email Address *</label>
                <input
              ...
              {/* Organization */}
              <div className="mb-4">
                <label className="block mb-2 text-xl font-medium">Organization *</label>
                <input
                  value={formData.organization}
                  onChange={handleChange}
                  name="organization"
                  className={`bg-gray-50 border ${errors.organization ? 'border-red-500' : 'border-gray-300'} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5`}
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    name="contactNumber"
                    type="tel"
                    className={`flex-1 bg-gray-50 border ${errors.contactNumber ? 'border-red-500' : 'border-gray-300'} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5`}
                    placeholder="Enter contact number"
                  />
                </div>
                {errors.contactNumber && <p className="text-red-500 text-sm mt-1">{errors.contactNumber}</p>}
                <p className="text-gray-500 text-xs mt-1">Format: {countryCodes.find(c => c.code === formData.countryCode)?.example}</p>
              </div>

              {/* Product Dropdown */}
              <div className="mb-4">
                <label className="block mb-2 text-xl font-medium">Product *</label>
                <select
                  value={formData.product}
                  onChange={handleChange}
                  name="product"
                  className={`bg-gray-50 border ${errors.product ? 'border-red-500' : 'border-gray-300'} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5`}
                >
              ...
              {/* Purpose of Enquiry */}
              <div className="mb-4">
                <label className="block mb-2 text-xl font-medium">Purpose of Enquiry *</label>
                <textarea
                  value={formData.purposeOfEnquiry}
                  onChange={handleChange}
                  name="purposeOfEnquiry"
                  rows="4"
                  className={`block p-2.5 w-full text-xl text-gray-900 bg-gray-50 rounded-lg border ${errors.purposeOfEnquiry ? 'border-red-500' : 'border-gray-300'} focus:ring-blue-500 focus:border-blue-500`}
                  placeholder="Please describe your enquiry..."
                ></textarea>
                {errors.purposeOfEnquiry && <p className="text-red-500 text-sm mt-1">{errors.purposeOfEnquiry}</p>}
              </div>
