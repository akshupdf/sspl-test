...
function Footer() {
  ...
  return (
    <div className="w-full bg-[#003662] text-gray-300 border-t border-white/5 py-2">
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-8 mb-4">
        {/* Address & Hours */}
      ...
      <div className="border-t border-white/5 pt-3 pb-2 text-center text-sm text-gray-400 space-y-1">
        <div>
          <Link
            to="/disclaimer"
