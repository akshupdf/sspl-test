...
function Footer() {
  ...
  return (
   ...
   <div className=' lg:w-[30%] '>
    ...
    <h1 className='font-bold pl-1 flex mb-4'><FaClock className='mr-2 mt-1 ' />  Monday To Friday :- 9am-6pm</h1>
    ...
    <p>+91 22 4057 0360</p>
    <a href={`mailto:${email}?subject=${subject}&body=${body}`}  className='cursor-pointer'>{email}</a>
    </div>
