...
function Footer() {
  ...
  return (
    <div>
      <div className="w-[100%] h-auto py-6 px-4 lg:flex border border-black bottom-0 font-weight-800  justify-center items-start mt-10 text-xl bg-[#003662] text-gray-300  font-serif">
        <div className=" lg:w-[30%] flex items-start">
          <div className=" mx-auto rounded-xl pt-2   cursor-pointer sm:pl-4  xl:pl-0 2xl:pl-0">
            ...
            <h1 className="font-bold pl-1 flex mb-4">
              <FaClock className="mr-2 mt-1 " /> Monday To Friday :- 9am-6pm
            </h1>
          </div>
        </div>

        <div className=" lg:w-[30%]  flex items-start">
          <div className=" m-auto sm:pl-6 pt-5 xl:pl-20 2xl:pl-20  text-xl rounded-xl   cursor-pointer">
            <ul>
        ...
        <div className=" lg:w-[30%]  flex items-start">
          <div className="flex mt-5 sm:pl-6  xl:pl-0 2xl:pl-0 w-full">
            <div>
...
<path fill="#3F51B5" d="M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z"></path><path fill="#FFF" d="M34.368,25H31v13h-5V25h-3v-4h3v-2.41c0.002-3.508,1.459-5.59,5.592-5.59H35v4h-2.287C31.104,17,31,17.6,31,18.723V21h4L34.368,25z"></path>
              ...
              <Link
                to="https://in.linkedin.com/company/satyanarayan-sekhsaria"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              {/* <button className='ml-4 border-white border   text-sm rounded-xl p-2' onClick={scrollToTop}><AiOutlineToTop  className='ml-1.5'/> <span className='pl-1 text-sm'>Top</span> </button>
               */}
            </div>
          </div>
        </div>
        <div className=" lg:w-[30%]  flex items-start">
          <div className="flex flex-col mt-5 sm:pl-6  xl:pl-0 2xl:pl-0 w-full">
